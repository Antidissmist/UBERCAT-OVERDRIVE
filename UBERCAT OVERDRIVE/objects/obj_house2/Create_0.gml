...
vertex_add_box_nofloors(vbuff, x,y,z, size, height,,,sp_house2_side);
...
tex1 = sprite_get_texture(sp_house2_side,0);
tex2 = sprite_get_texture(sp_house2_top,0);
